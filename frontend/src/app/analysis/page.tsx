                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-border/40">
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-lg font-bold">
                                                {((analysisResult.executive_summary.rag_metadata.tokens_input || 0) +
                                                    (analysisResult.executive_summary.rag_metadata.tokens_output || 0)).toLocaleString()} <span className="text-xs font-normal text-muted-foreground/60">tkns</span>
                                            </p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Logic Engine</p>
                                            <p className="text-lg font-bold text-violet-500">{(analysisResult.executive_summary.rag_metadata.model || 'Unknown-Model').split('-')[0].toUpperCase()}</p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Inference Lag</p>
                                            <p className="text-lg font-bold">{(analysisResult.executive_summary.rag_metadata.latency || 0).toFixed(2)}<span className="text-xs font-normal text-muted-foreground/60">s</span></p>
                                        </div>
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Knowledge Base</p>
                                            <p className="text-lg font-bold">{analysisResult.executive_summary.rag_metadata.retrieval_count || 0} <span className="text-xs font-normal text-muted-foreground/60">Sources</span></p>
                                        </div>
                                    </div>
                                )}
                            </CardContent>
