    ...
    */
    ...
    const formatCellValue = (value: any, columnName?: string): string => {
        ...
        if (typeof value === 'number') {
            // Percentage checks FIRST (prevents spend_change_pct from being caught by currency check)
            if (colLower.includes('_pct') || colLower.includes('percent') || colLower.includes('ctr') || colLower.includes('rate') || colLower.includes('conversion_rate')) {
